...
public class PackageManagerEvents
{
    ...
    public static String ERROR_FORCE_STOP_APP = "ERROR_FORCE_STOP_APP";
    public static String ERROR_UNINSTALL_APP = "ERROR_UNINSTALL_APP";
    public static String ERROR_CLEAR_DATA_AND_CACHE_APP = "ERROR_CLEAR_DATA_AND_CACHE_APP";
    ...
    public static String SUCCESS_FORCE_STOP_APP = "SUCCESS_FORCE_STOP_APP";
    public static String SUCCESS_UNINSTALL_APP = "SUCCESS_UNINSTALL_APP";
    public static String SUCCESS_CLEAR_DATA_AND_CACHE_APP = "SUCCESS_CLEAR_DATA_AND_CACHE_APP";
}
